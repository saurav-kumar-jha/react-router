        ...
        <>
            <nav className={`md:h-[400px] md:w-[20%] md:min-w-28 border h-[30px] w-[33px] flex justify-center items-center rounded border-transparent md:px-2 md:py-4 md:mx-3 md:mr-3 glassmor`}>
                ...
                <ul className="md:block hidden w-[90%] ">
                    ...
                    <li>
                        <NavLink to="/home" className="text-lg hover:text-[#6991db] hover:bg-zinc-600 cursor-pointer my-[20px] h-9 flex items-center justify-center text-center w-[100%] rounded font-semibold "><IoMdHome /> HOME</NavLink>
                    </li>
                    <li>
                    ...
                    <li>
                        <NavLink to="/contact" className="text-lg hover:text-[#6991db] hover:bg-zinc-600 cursor-pointer my-[20px] h-9 flex items-center justify-center text-center w-[100%] rounded font-semibold "><IoIosContact /> CONTACT</NavLink>
                    </li>
                </ul>
            </nav>
        </>
